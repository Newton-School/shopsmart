...
export default function Categories() {
  const categories = [
    ...
    { name: "Sports & Active", count: "55+ Products", image: "https://images.unsplash.com/photo-1608043152269-423dbba4e7e1?w=800&q=80" },
  ];
  ...
  return (
    <div className="bg-white min-h-screen pt-32 pb-20 px-4 sm:px-6 lg:px-8 font-sans">
      <div className="max-w-7xl mx-auto">
        ...
        <h1 className="text-4xl md:text-5xl font-bold text-[#003D29] mb-4">Shop by Category</h1>
        <p className="text-gray-600 mb-12 max-w-2xl text-lg">Explore our wide range of premium audio equipment designed for every lifestyle, profession, and passion.</p>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {categories.map((cat, idx) => (
            <div key={idx} className="group cursor-pointer rounded-3xl overflow-hidden bg-[#F8F9FA] relative aspect-4/3 flex items-center justify-center p-8">
